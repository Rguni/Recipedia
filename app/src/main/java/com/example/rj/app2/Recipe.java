...
public class Recipe implements Serializable {
    ...
    private byte[] Dishes_Picture;
        ...
        public Recipe(String Dishes_Name, String Dishes_Description, byte[] Dishes_Picture) {
            this.Dishes_Name = Dishes_Name;
            this.Dishes_Description = Dishes_Description;
            this.Dishes_Picture = Dishes_Picture;
        }

        public Recipe(int Dishes_ID, String Dishes_Name, String Dishes_Description, byte[] Dishes_Picture) {
